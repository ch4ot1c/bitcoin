...
http://sourceforge.net/projects/bitcoin/files/BTCP/bitcoin-0.6.0/test/
...
BTCP-Qt can display and save QR codes for sending
...
BTCP-Qt's initial splash screen
...
opening/launching BTCP-Qt is available only on Linux,
and only if you configure your desktop to launch
BTCP-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the BTCP-Qt window to start
payment.
...
It is expected that future releases of BTCP-Qt
