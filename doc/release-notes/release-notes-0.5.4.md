...
http://sourceforge.net/projects/bitcoin/files/BTCP/bitcoin-0.5.4/
...
Fix BTCP-Qt notifications under Growl 1.3.
Increase required age of BTCP-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing BTCP-Qt over it. (Windows)
