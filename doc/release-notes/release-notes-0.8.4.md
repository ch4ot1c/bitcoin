BTCP-Qt version 0.8.4 is now available from:
  http://sourceforge.net/projects/bitcoin/files/BTCP/bitcoin-0.8.4/
...
code, causing the BTCP-Qt or bitcoind process to crash.
