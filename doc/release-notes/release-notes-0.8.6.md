BTCP-Qt version 0.8.6 final is now available from:

  http://sourceforge.net/projects/bitcoin/files/BTCP/bitcoin-0.8.6/
...
- Fix BTCP-Qt startup crash when clicking dock icon on OSX 
