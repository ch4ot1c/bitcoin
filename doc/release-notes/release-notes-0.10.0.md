...
installer (on Windows) or just copy over /Applications/BTCP-Qt (on Mac) or
...
- `bd0aa10` Replace the temporary file hack currently used to change BTCP-Qt's dock icon (OS X) with a buffer-based solution
