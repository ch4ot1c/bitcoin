...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\BTCP
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\BTCP
    // Mac: ~/Library/Application Support/BTCP
    // Unix: ~/.bitcoin
#ifdef WIN32
    // Windows
