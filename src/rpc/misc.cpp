...
static UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        std::string msg = "createmultisig nrequired \"keys\" ( \"address_type\" )\n"
            ...
            "2. \"keys\"                       (array of strings, required) A json array of hex-encoded public keys\n"
            "     [\n"
...
UniValue logging(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 2) {
        throw std::runtime_error(
            ...
            "     ]\n"
            "\nResult:\n"
            "{                   (object) A json object where keys are the logging categories, and values indicates its status\n"
