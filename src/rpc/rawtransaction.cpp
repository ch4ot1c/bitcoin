...
static UniValue combinerawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"txs\"         (array of strings) A json array of hex strings of partially signed transactions\n"
            "    [\n"
...
static UniValue signrawtransactionwithkey(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "      ,...\n"
            "    ]\n"
            "3. \"prevtxs\"                        (string, optional) A json array of previous dependent transaction outputs\n"
            "     [                              (array of objects)\n"
            "       {\n"
            "         \"txid\":\"id\",               (string, required) The transaction id\n"
            "         \"vout\":n,                  (numeric, required) The output number\n"
...
UniValue combinepsbt(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"txs\"                   (array) A json array of base64 strings of partially signed transactions\n"
            "    [\n"
